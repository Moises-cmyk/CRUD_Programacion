...
public class BajaCurso extends Frame implements WindowListener, ActionListener
{

	private static final long serialVersionUID = 1L;
	Label lblCurso = new Label("Curso borrar:");
	...
	public void actionPerformed(ActionEvent e) {
		...
		else if(objetoPulsado.equals(btnSi))
		{
			...
			{
				System.out.println("Error en baja de Curso");
			}
	...
	public int borrar(Connection con, int idCurso)
	{
		int respuesta = 0;
