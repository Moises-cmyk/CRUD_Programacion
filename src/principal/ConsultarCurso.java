...
public class ConsultarCurso extends Frame implements WindowListener, ActionListener 
{
	...
	public void actionPerformed(ActionEvent ae) {
		...
		try
		{
			...
			FileOutputStream ficheroPdf = new FileOutputStream("ficheroCurso.pdf");
			// Se asocia el documento al OutputStream y se indica que el espaciado entre
			// lineas sera de 20. Esta llamada debe hacerse antes de abrir el documento
			PdfWriter.getInstance(documento,ficheroPdf).setInitialLeading(20);
			// Se abre el documento.
			documento.open();
			documento.add(new Paragraph("Está usted consultando la tabla Curso.",
					FontFactory.getFont("arial",/*Fuente*/16,/*tamaño*/Font.ITALIC)));
			...
			try {
				...
				{ 
						...
						tabla.addCell(rs.getString("idCurso"));
